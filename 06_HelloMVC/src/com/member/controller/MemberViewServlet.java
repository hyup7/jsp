...
public class MemberViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//역할 ! 클라이언트가보낸 아이디하고 일치하는 회원의 정보를 가져와
		//그정보를 출력해주는 페이지와 연결
		...
		System.out.println("오냐"+m.getUserId()+m.getPassword()+m.getUserName()+m.getAge()+m.getAddress()+m.getEmail()+m.getEnrolldate()+m.getHobby());
