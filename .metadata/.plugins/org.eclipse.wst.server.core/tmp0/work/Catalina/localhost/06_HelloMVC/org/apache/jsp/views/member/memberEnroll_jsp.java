 ...
 * Generated at: 2021-06-29 09:15:11 UTC
...
if(loginMember!=null&&loginMember.getUserId().equals("admin")){ 
      ...
      out.print(request.getContextPath() );
      out.write("/memberEnrollEnd\" method=\"post\" onsubmit=\"return fn_invalidate2();\" >\r\n");
      out.write("        <table>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>아이디</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" placeholder=\"4글자이상\" name=\"userId\" id=\"userId_\" >\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" onclick=\"fn_duplicateId();\">아이디 중복확인</button>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>패스워드</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"password\" name=\"password\" id=\"password_\" ><br>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>패스워드확인</th>\r\n");
      out.write("\t\t\t\t<td>\t\r\n");
      out.write("\t\t\t\t\t<input type=\"password\" id=\"password_2\" ><br>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>  \r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>이름</th>\r\n");
      ...
      out.write("        </form>\r\n");
      out.write("        <form name=\"duplicateFrm\" action=\"\" method=\"post\">\r\n");
      out.write("        \t<input type=\"hidden\" name=\"userId\">\r\n");
      out.write("        </form>\r\n");
      out.write("    </section>\r\n");
      out.write("    <script>\r\n");
      out.write("    $(\"#password_2\").blur((e)=>{\r\n");
      out.write("    \tconst pw=$(\"#password_\").val();\r\n");
      out.write("   \t\tconst pwck=$(e.target).val();\r\n");
      ...
      out.write("   \t\t\r\n");
      out.write("    });\r\n");
      out.write("    const fn_invalidate2=()=>{\r\n");
      out.write("    \t//form태그에 있는 input태그의 값을 확인한다.\r\n");
      out.write("    \tconst userId=$(\"#userId_\").val();\r\n");
      out.write("    \tif(userId.trim().length<4){\r\n");
      out.write("    \t\talert(\"아이디는 4글자 이상으로 작성하세요\");\r\n");
      out.write("    \t\t$(\"#userId_\").focus();\r\n");
      out.write("    \t\treturn false;\r\n");
      out.write("    \t}\r\n");
      out.write("    }\r\n");
      out.write("\tconst fn_duplicateId=()=>{\r\n");
      out.write("\t\tconst status=\"width=300px,height=200px,left=500px,top=500px\";\r\n");
      out.write("\t\tconst title=\"duplicateId\";\r\n");
      out.write("\t\tconst url=\"");
      out.print(request.getContextPath());
      out.write("/checkDuplicateId\";\r\n");
      out.write("\t\t\r\n");
      out.write("\t\topen(\"\",title,status);\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tconsole.log(duplicateFrm);\r\n");
      out.write("\t\tduplicateFrm.userId.value=$(\"#userId_\").val();\r\n");
      out.write("\t\tduplicateFrm.target=title;\r\n");
      out.write("\t\tduplicateFrm.action=url;\r\n");
      out.write("\t\tduplicateFrm.submit();\r\n");
      out.write("\t}\r\n");
      out.write("   \r\n");
      out.write("    \t\r\n");
      out.write("    \r\n");
